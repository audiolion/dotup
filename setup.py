...
setup(
    ...
    url="https://github.com/audiolion/dotup",  # Optional
    author="Ryan Castner",  # Optional
    author_email="castner.rr@gmail.com",  # Optional
    ...
    keywords=' '.join(['dotfiles', 'cli', 'symlink', 'updater',
                       'update']),  # Optional
    ...
    project_urls={  # Optional
        'homepage': 'https://github.com/audiolion/dotup',
    },
)
